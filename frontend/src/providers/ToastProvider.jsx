...
export function ToastProvider({ children }) {
  ...
  return <ToastContext.Provider value={show}>
    {children}
    {toast && <div role="status" aria-live="polite" className="soft-enter fixed bottom-28 left-1/2 z-50 flex w-[calc(100%-2rem)] max-w-md -translate-x-1/2 items-center gap-3 rounded-full border border-white/15 bg-zinc-950/90 px-5 py-3 text-white shadow-2xl backdrop-blur-2xl">

...
export default function Favorites() {
  ...
  const favorites = useQuery({ queryKey: ['prompts', 'favorites'], queryFn: () => promptsApi.list({ favorite: true }) });
  ...
  return <Page><Header title="Favorites" subtitle="The prompts you want close at hand" back />
    <SectionTitle eyebrow="Saved with care">Favorite prompts</SectionTitle>
